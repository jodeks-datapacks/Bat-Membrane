function batmembrane:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    "Bat Membrane",\
    {text: "Disables phantoms and lets bat drop phantom_membrane", color: "#aaaaaa"},\
    "",\
    [{text: "Datapack version: ", color: "#00a800"}, {text: "v.3.0.0", color: "#54fc54"}],\
